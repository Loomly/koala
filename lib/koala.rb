...
module Koala
  ...
  def self.make_request(path, args, verb, options = {}, &block)
    http_service.make_request(HTTPService::Request.new(path: path, args: args, verb: verb, options: options), &block)
  end
